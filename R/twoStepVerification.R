	...
	#' @export
	twoStepVerification.turnOff <- function(userKey, callback = NULL, fields = NULL, uploadType = NULL, upload_protocol = NULL, prettyPrint = NULL, quotaUser = NULL, alt = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.twoStepVerification.turnOff']]$scopes[[1]]), return_request = F, return_response = F){
